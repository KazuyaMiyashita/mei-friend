      ...
      <div className="dialog" style={{ maxWidth: '500px' }}>
        ...
        <div className="dialogForm">
          <p style={{ color: 'var(--color-fg)', lineHeight: '1.5' }}>
            When editing files in the workspace, there are two ways to save your changes: saving
            only within the browser memory, or allowing the browser to access your device's file
            system to edit files directly. Which method would you like to use?
          </p>
        ...
        <div className="dialogActions">
          ...
          <button type="button" className="buttonPrimary" onClick={() => onConfirm(mode)}>
            OK
          </button>
        </div>
      </div>
